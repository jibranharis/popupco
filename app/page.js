      ...
      <div className={styles.overContent}>
        ...
        <section className={styles.earlyStageSection}>
          <div className={`container ${styles.earlyStageInner}`}>
            <div className={styles.earlyStageColumns}>
              {/* Left Column */}
              <div className={`fade-in ${styles.earlyStageLeft}`}>
                <div className={styles.earlyStageLogo}>
                  <Store size={22} strokeWidth={2} />
                  <span>PopUpCo.</span>
                </div>
                <span className="label">EARLY ACCESS</span>
                <h2>Built for better<br />pop-up matches.</h2>
                <p>
                  PopUpCo is currently <span style={{color: '#c85f2c'}}>early access</span>.<br />
                  We're onboarding a small group of vendors, hosts, and<br />
                  venues to build a marketplace that works in the real world.
                </p>
                <div className={styles.earlyStageGrid}>
                  <div className={styles.earlyStageCard}>
                    <div className={styles.earlyStageIcon}><Tag size={18} strokeWidth={1.5} /></div>
                    <h3>For vendors</h3>
                    <p>Compare booth fees, attendance ranges, setup windows, and requirements before applying.</p>
                  </div>
                  <div className={styles.earlyStageCard}>
                    <div className={styles.earlyStageIcon}><Search size={18} strokeWidth={1.5} /></div>
                    <h3>For hosts</h3>
                    <p>Collect better-fit vendor interest and organize event details in one place.</p>
                  </div>
                  <div className={styles.earlyStageCard}>
                    <div className={styles.earlyStageIcon}><Users size={18} strokeWidth={1.5} /></div>
                    <h3>For venues</h3>
              ...
              {/* Right Column */}
              <div className={`fade-in fade-in--d1 ${styles.earlyStageRight}`}>
                <div className={styles.earlyAccessPanel}>
                  <div className={styles.earlyAccessPanelHeader}>
                    CURRENTLY IN EARLY ACCESS
                  </div>
                  <div className={styles.earlyAccessList}>
                    <div className={styles.earlyAccessItem}>
                      <div className={styles.earlyAccessIcon}><Users size={22} strokeWidth={1.5} /></div>
                      <div className={styles.earlyAccessText}>
                        <h4>Founding vendors, hosts,<br />and venues welcome</h4>
                        <p>We're inviting a small group of early<br />users to shape PopUpCo from the start.</p>
                      </div>
                    </div>
                    <div className={styles.earlyAccessItem}>
                      <div className={styles.earlyAccessIcon}><MessageSquare size={22} strokeWidth={1.5} /></div>
                      <div className={styles.earlyAccessText}>
                        <h4>Early access means direct<br />input on the platform</h4>
                        <p>Your feedback helps us build the features<br />that matter most.</p>
                      </div>
                    </div>
                    <div className={styles.earlyAccessItem}>
                      <div className={styles.earlyAccessIcon}><Leaf size={22} strokeWidth={1.5} /></div>
                      <div className={styles.earlyAccessText}>
                        <h4>Best for people who want<br />to help shape the marketplace</h4>
                        <p>Be part of the foundation and help create<br />better matches for your community.</p>
                      </div>
                    </div>
                  </div>
                  <div className={styles.earlyAccessCallout}>
                    <Mail size={18} strokeWidth={1.5} />
                    <span>Spots are limited as we build with care.<br />Join early and help us get it right.</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Bottom Banner */}
            <div className={`fade-in fade-in--d2 ${styles.earlyStageBanner}`}>
              <div className={styles.bannerContent}>
                <Leaf size={48} className={styles.bannerDeco} strokeWidth={1} />
                <h3>Early access is the best way to get in first<br />and help shape what comes next.</h3>
              </div>
              <Link href="/apply/vendor/interest" className={styles.bannerBtn}>REQUEST EARLY ACCESS &nbsp;<ArrowRight size={16} /></Link>
            </div>
          </div>
        </section>
