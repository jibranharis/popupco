      ...
      <main ref={pageRef} className={styles.page}>
        ...
        <section className={styles.rolesSection} id="how-it-works">
          <div className={styles.roleScene} aria-hidden="true">
            <svg viewBox="0 0 760 360" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M42 126C108 72 225 72 292 126" />
              <path d="M94 112V153M151 92V153M209 92V153M266 112V153" />
              <path d="M99 145C108 153 108 166 99 174C90 166 90 153 99 145Z" />
              <path d="M156 128C165 136 165 149 156 157C147 149 147 136 156 128Z" />
              <path d="M214 128C223 136 223 149 214 157C205 149 205 136 214 128Z" />
              <path d="M270 145C279 153 279 166 270 174C261 166 261 153 270 145Z" />
              <path d="M116 260V166H314V260" />
              <path d="M82 166L214 66L346 166H82Z" />
              <path d="M143 196H288M143 223H288" />
              <path d="M188 260V222H240V260" />
              <path d="M364 260V152H640V260" />
              <path d="M328 152L502 48L677 152H328Z" />
              <path d="M395 184H612M395 214H612" />
              <path d="M426 260V214H486V260" />
              <path d="M536 260V202C536 178 556 158 580 158C604 158 624 178 624 202V260" />
              <path d="M636 74H730V260" />
              <path d="M656 102H712M656 126H712M656 150H712" />
              <path d="M57 260C57 226 80 202 110 202C140 202 163 226 163 260" />
              <path d="M90 227C69 236 56 248 47 264" />
              <path d="M122 227C143 236 157 248 165 264" />
              <path d="M24 264H728" />
            </svg>
          </div>
