...
const WHO_FOR = [
  { icon: '🚀', label: 'First-time vendors', desc: 'Sell in person for the first time without a long-term commitment.' },
  { icon: '🎓', label: 'Student businesses', desc: 'Launch your student brand at a real market.' },
  { icon: '💻', label: 'Online brands', desc: 'Take your online store offline and meet real customers.' },
  { icon: '🕶️', label: 'Vintage sellers', desc: 'Curated vintage, thrifted, and resale collections.' },
  { icon: '🎨', label: 'Artists & makers', desc: 'Prints, paintings, ceramics, handmade goods.' },
  { icon: '🚛', label: 'Food trucks', desc: 'Food, beverage, and truck vendors welcome with additional approval.' },
  { icon: '🤝', label: 'Nonprofits', desc: 'Community orgs may qualify for discounted vendor spots.' },
  { icon: '🏪', label: 'Local businesses', desc: 'Service and product businesses expanding reach.' },
];
...
const STEPS = [
  ...
  { num: '03', title: 'Acceptance & payment', desc: 'Accepted vendors receive details on next steps and booth fee payment. A $25 application fee is credited toward your booth fee.' },
        ...
        <section className={styles.hero}>
          <div className="container">
            ...
            <h1 className={styles.headline}>
              Sell in person without<br />figuring it all out alone.
            </h1>
              ...
              <div className={`fade-in ${styles.getVisual}`}>
                <div className={styles.pricingPreview}>
                  <div className={styles.pricingRow}>
                    ...
                    <span className={styles.pricingVal}>$75–$250</span>
                  </div>
                  <div className={styles.pricingDivider} />
                  <div className={styles.pricingRow}>
                    <span className={styles.pricingLabel}>Application fee</span>
                    <span className={styles.pricingVal}>$25 (credited if accepted)</span>
                  </div>
                  <div className={styles.pricingDivider} />
                  <div className={styles.pricingRow}>
          ...
          <div className="container">
            <div className={styles.ctaInner}>
              ...
              <p className={`fade-in ${styles.ctaSub}`}>
                Submitting an application is free to start. A $25 application fee is collected before review and credited toward your booth fee if accepted.
              </p>
