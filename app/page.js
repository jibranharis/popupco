      ...
      <main ref={pageRef} className={styles.page}>
        ...
        <section className={styles.rolesSection} id="how-it-works">
          <div className={styles.roleScene} aria-hidden="true">
            <svg viewBox="0 0 980 430" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path className={styles.sceneWash} d="M170 28C344 -18 596 4 786 103C929 178 985 302 905 404H96C41 329 49 214 122 117C136 98 151 64 170 28Z" />
              <path d="M35 142C171 63 375 64 510 142C640 218 767 207 936 132" />
              <path d="M121 102C128 110 128 122 121 130C114 122 114 110 121 102Z" />
              <path d="M199 80C206 88 206 100 199 108C192 100 192 88 199 80Z" />
              <path d="M278 78C285 86 285 98 278 106C271 98 271 86 278 78Z" />
              <path d="M360 96C367 104 367 116 360 124C353 116 353 104 360 96Z" />
              <path d="M451 132C458 140 458 152 451 160C444 152 444 140 451 132Z" />
              <path d="M142 214L282 98L421 214H142Z" />
              <path d="M282 98L282 214" />
              <path d="M176 214V338M386 214V338" />
              <path d="M143 214H421" />
              <path d="M163 237H403" />
              <path d="M178 237C189 252 201 252 212 237C223 252 235 252 246 237C257 252 269 252 280 237C291 252 303 252 314 237C325 252 337 252 348 237C359 252 371 252 382 237" />
              <path d="M196 285H366M196 314H366" />
              <path d="M236 338V294H328V338" />
              <path d="M407 226L566 92L725 226H407Z" />
              <path d="M566 92L566 226" />
              <path d="M448 226V338M684 226V338" />
              <path d="M407 226H725" />
              <path d="M428 251H704" />
              <path d="M444 251C457 269 470 269 483 251C496 269 509 269 522 251C535 269 548 269 561 251C574 269 587 269 600 251C613 269 626 269 639 251C652 269 665 269 678 251" />
              <path d="M465 297H664M465 323H664" />
              <path d="M522 338V291H610V338" />
              <path d="M742 76H927V339" />
              <path d="M722 112H948" />
              <path d="M760 145H903M760 177H903M760 209H903" />
              <path d="M792 339V259C792 229 817 204 847 204C877 204 902 229 902 259V339" />
              <path d="M738 339H950" />
              <path d="M919 92L953 66" />
              <path d="M752 76L728 52" />
              <path d="M64 339C64 297 94 266 132 266C170 266 200 297 200 339" />
              <path d="M101 302C78 314 62 329 52 348" />
              <path d="M160 303C181 316 195 331 205 348" />
              <path d="M40 352H938" />
              <path d="M238 352V314H370V352" />
              <path d="M255 322H353M255 340H353" />
              <path d="M493 352V314H639V352" />
              <path d="M512 322H620M512 340H620" />
              <path d="M805 352V322H909V352" />
              <path d="M821 331H893" />
              <path d="M732 290H768M732 309H768" />
            </svg>
          </div>
